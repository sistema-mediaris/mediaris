...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2016 at 04:46 AM
...
INSERT INTO `cidade_instituicao` (`instituicoes_id`, `cidades_id`) VALUES
(1, 5098);
...
INSERT INTO `cursos` (`id`, `nome`, `duracao_sem`, `duracao_ano`) VALUES
(1, 'Agronegócios', 6, 3),
(2, 'Análise e Desenvolvimento de Sistemas', 6, 3);

--
-- Dumping data for table `curso_disciplina`
--

INSERT INTO `curso_disciplina` (`cursos_id`, `disciplinas_id`) VALUES
(1, 1),
(1, 2),
(1, 4),
(1, 6),
...
INSERT INTO `curso_grau_academico` (`cursos_id`, `graus_academicos_id`) VALUES
(1, 1),
(2, 1);
...
INSERT INTO `curso_instituicao` (`instituicoes_id`, `cursos_id`) VALUES
(1, 1),
(1, 2);
...
INSERT INTO `curso_turno` (`cursos_id`, `turnos_id`) VALUES
(1, 1),
(1, 3),
(2, 2),
(2, 3);
...
(3, 'Algoritimos e Lógica de Programação'),
(4, 'Análise Financeira'),
(5, 'Arquitetura e Organização de Computadores'),
(6, 'Arranjos Produtivos'),
...
(13, 'Contabilidade'),
(14, 'Custos e Orçamentos no Agronegócio'),
(15, 'Cálculo'),
(16, 'Defesa Sanitária e Fitossanitária'),
(17, 'Economia e Finanças'),
(18, 'Economia e Políticas Agrícolas'),
(19, 'Empreendedorismo'),
(20, 'Engenharia de Software I'),
(21, 'Engenharia de Software II'),
(22, 'Engenharia de Software III'),
(23, 'Espanhol'),
(24, 'Estatística'),
(25, 'Estatística Aplicada'),
(26, 'Estrutura de Dados'),
(27, 'Fundamentos de Gestão de Pessoas'),
(28, 'Fundamentos do Agronegócio'),
(29, 'Gestão Ambiental'),
(30, 'Gestão Estratégica no Agronegócio'),
(31, 'Gestão da Qualidade e Certificação'),
(32, 'Gestão de Equipes'),
(33, 'Gestão de Projetos'),
(34, 'Gestão e Governança de TI'),
(35, 'Informática Aplicada ao Agronegócio'),
(36, 'Infraestrutura do Agronegócio'),
(37, 'Inglês I'),
(38, 'Inglês II'),
(39, 'Inglês III'),
(40, 'Inglês IV'),
...
(45, 'Laboratório de Banco de Dados'),
(46, 'Laboratório de Engenharia de Software'),
(47, 'Laboratório de Hardware'),
(48, 'Laboratório de Redes'),
(49, 'Linguagem de Programação'),
(50, 'Logística no Agronegócio'),
(51, 'Marketing'),
(52, 'Matemática Discreta'),
(53, 'Matemática Financeira'),
(54, 'Metodologia de Pesquisa Científico-Tecnológica'),
(55, 'Noções de Direito'),
(56, 'Pesquisa Operacional'),
(57, 'Português I'),
(58, 'Produção Agroindustrial I'),
(59, 'Produção Agroindustrial II'),
(60, 'Programação Linear e Aplicações'),
(61, 'Programação Orientada a Objetos'),
(62, 'Programação em Microinformática'),
(63, 'Projeto de Agronegócio I'),
(64, 'Projeto de Agronegócio II'),
(65, 'Projeto de Agronegócio III'),
(66, 'Redes de Computadores'),
(67, 'Saúde e Segurança Ocupacional'),
(68, 'Segurança da Informação'),
(69, 'Sistemas Operacionais I'),
(70, 'Sistemas Distribuídos'),
(71, 'Sistemas Operacionais II'),
(72, 'Sistemas de Informação'),
(73, 'Sistemas de Informação no Agronegócio'),
(74, 'Sociedade e Tecnologia'),
(75, 'Tecnologia de Produção Animal I'),
(76, 'Tecnologia de Produção Animal II'),
(77, 'Tecnologia de Produção Vegetal I'),
(78, 'Tecnologia de Produção Vegetal II'),
(79, 'Ética e Responsabilidade Profissional');
...
INSERT INTO `graus_academicos` (`id`, `nome`) VALUES
(1, 'Tecnólogo'),
(2, 'Bacharelado'),
(3, 'Licenciatura'),
(4, 'Especialização'),
...
INSERT INTO `instituicoes` (`id`, `nome`, `sigla`) VALUES
(1, 'Faculdade de Tecnologia', 'FATEC');

--
-- Dumping data for table `tipos_arquivos`
--

INSERT INTO `tipos_arquivos` (`id`, `extensao`) VALUES
(1, 'ZIP'),
(2, 'RAR'),
(3, '7z'),
(4, 'PDF'),
...
INSERT INTO `titulacoes` (`id`, `nome`, `abreviacao`) VALUES
(1, 'Bacharel', 'Bel.'),
(2, 'Doutor', 'Dr.'),
(3, 'Especialista', 'Esp.'),
(4, 'Licenciado', 'Lic.'),
...
--
ALTER TABLE `turmas`
  ADD CONSTRAINT `turmas_cursos` FOREIGN KEY (`cursos_id`) REFERENCES `turmas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
